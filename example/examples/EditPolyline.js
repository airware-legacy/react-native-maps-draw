...
import { EditablePolyline } from 'react-native-maps-draw';
...
class EditPolyline extends React.Component {
  constructor(props) {
    super(props);
...
EditPolyline.propTypes = {
  provider: MapView.ProviderPropType,
};

module.exports = EditPolyline;
